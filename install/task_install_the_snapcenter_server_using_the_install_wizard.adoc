...
---
= 在 Windows 主机上安装 SnapCenter 服务器
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
您可以选择使用 PowerShell cmdlet 执行多个安装和配置过程。您应该使用 PowerShell 7.4.13 或更高版本。
...
** .NET 可扩展性 4.5
** 应用程序初始化
** ASP.NET Core 10.0.7 托管捆绑包（或更高版本）请参阅 link:https://library.netapp.com/ecm/ecm_download_file/ECMLP3359467["SnapCenter 软件发行说明"^]，了解适用于您特定 SnapCenter 版本的 ASP.NET Core 最新合格版本。
** 服务器端包括
** WebSocket 协议
...
+
** TCP 激活
** HTTP Activation 有关特定 SnapCenter 版本的 ASP.NET Core 最新合格版本，请参阅 link:https://library.netapp.com/ecm/ecm_download_file/ECMLP3359467["SnapCenter 软件发行说明"^]。
