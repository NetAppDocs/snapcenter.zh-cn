...
+
有关权限列表的信息，请参见 link:task_create_an_ontap_cluster_role_with_minimum_privileges.html#ontap-cli-commands-for-creating-cluster-roles-and-assigning-permissions["用于创建角色和分配权限的 ONTAP 命令行界面命令"^]。
