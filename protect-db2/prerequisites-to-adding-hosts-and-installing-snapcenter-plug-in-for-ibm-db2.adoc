...
---
= 添加主机并安装适用于 IBM Db2 的 SnapCenter 插件的先决条件
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* 您必须已为 root 用户或非 root 用户启用基于密码的 SSH 连接。
* 必须在 Linux 或 AIX 主机上为 SnapCenter 6.2.1 及更高版本安装 Java 17（Oracle Java、OpenJDK 或 SAP JDK），或为 SnapCenter 6.2 及更早版本安装 Java 11。
+
link:https://www.oracle.com/java/technologies/downloads/#java17["下载适用于 Linux 的 Java"^]

+
link:https://developer.ibm.com/languages/java/semeru-runtimes/downloads/?license=IBM["下载适用于 AIX 的 Java"^]
