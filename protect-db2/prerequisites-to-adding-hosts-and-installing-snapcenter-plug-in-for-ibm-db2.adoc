...
+
link:https://www.oracle.com/java/technologies/javase/jdk11-archive-downloads.html["下载适用于 Windows 的 JAVA"^]
...
+
link:https://www.oracle.com/java/technologies/javase/jdk11-archive-downloads.html["下载适用于 Linux 的 JAVA"^]
