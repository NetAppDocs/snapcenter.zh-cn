...
---
= 使用 SnapCenter Plug-in for IBM Db2 的先决条件
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* 在 Linux 或 Windows 主机上，为 SnapCenter 6.2.1 及更高版本安装 Java 17（Oracle Java、OpenJDK 或 SAP JDK），或为 SnapCenter 6.2 及更早版本安装 Java 11。
+
