...
. 单击 image:../media/filter_icon.png["筛选器图标"]，然后选择主机名和数据库类型以筛选资源。
+
...
NOTE: 您也可以通过单击来创建策略 image:../media/add_policy_from_resourcegroup.gif["添加策略"]。
...
+
.. 单击 image:../media/add_policy_from_resourcegroup.gif["添加策略"] 要为其配置计划的策略的配置计划列。
