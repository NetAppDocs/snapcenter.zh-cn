...
---
= SnapCenter 如何从适用于 Oracle 和 SAP 的 SnapManager 导入数据
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
SnapCenter Oracle 数据库插件支持的配置列于此处。 https://imt.netapp.com/imt/imt.jsp?components=180320;180338;180332;&solution=1257&isHWU&src=IMT["NetApp 互操作性表工具"^]。
