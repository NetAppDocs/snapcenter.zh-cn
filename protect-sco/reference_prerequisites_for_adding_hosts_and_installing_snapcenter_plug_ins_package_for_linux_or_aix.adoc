...
* 您必须在 Linux 或 AIX 主机上安装 Java 17、Java 11（仅适用于 SnapCenter 6.2）。
+
...
NOTE: 请确保仅在 Linux 主机上安装了认证版本的 Java 17、Java 11（仅适用于 SnapCenter 6.2）。
...
所需的软件包
 a| 
Java 17（Oracle 或 OpenJDK）、Java 11（仅适用于 SnapCenter 6.2）
...
所需的软件包
 a| 
IBM Java 17、IBM Java 11（仅适用于 SnapCenter 6.2）
