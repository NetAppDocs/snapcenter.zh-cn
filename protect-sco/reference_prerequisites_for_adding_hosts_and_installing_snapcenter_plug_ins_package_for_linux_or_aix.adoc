...
* 您必须已安装 Java 17（用于 SnapCenter 6.2.1 及更高版本）或
* Linux 或 AIX 主机上的 Java 11（适用于 SnapCenter 6.2 及更早版本）。
+
** Linux 支持来自 Oracle 和 OpenJDK 的 Java。
...
所需的软件包
 a| 
* 适用于 SnapCenter 6.2.1 及更高版本的 Java 17（Oracle 或 OpenJDK）或
* Java 11 适用于 SnapCenter 6.2 及更早版本
