...
---
= 在 SnapCenter 中为 Oracle 数据库定义备份策略
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
有关受支持的 Oracle 版本的最新信息，请参阅 https://imt.netapp.com/imt/imt.jsp?components=180338;180332;134509;180320;&solution=1257&isHWU&src=IMT["NetApp 互操作性表工具"^]。
...
可以通过运行 Get-Help command_name 获取有关可与命令一起使用的参数及其描述的信息。或者，您也可以参考 https://library.netapp.com/ecm/ecm_download_file/ECMLP3359469["《 SnapCenter 软件命令参考指南》"^]。
