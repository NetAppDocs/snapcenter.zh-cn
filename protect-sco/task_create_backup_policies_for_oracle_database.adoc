...
NOTE: 主SnapLock设置在SnapCenter备份策略和二级中进行管理
SnapLock设置由ONTAP管理。
...
请参见 link:..protect-sco/task_view_oracle_databse_backups_and_clones_in_the_topology_page.html["在 Topology 页面中查看 Oracle 数据库备份和克隆"]。
