...
* 为安装用户创建身份验证模式为 Linux 或 AIX 的凭据。 link:../protect-sco/task_set_up_credentials_for_installing_the_plug_in_package_for_linux_or_aix.html["了解更多信息。"^]
* 添加主机，安装插件以及发现资源。
...
+
请参见 link:../protect-sco/reference_host_requirements_for_installing_the_snapcenter_plug_in_package_for_linux.html["Linux 主机要求"^] 或  有关详细信息 ...
