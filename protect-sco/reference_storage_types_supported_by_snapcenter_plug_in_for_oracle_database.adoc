...
---
= 适用于 Oracle 数据库的 SnapCenter 插件支持的存储类型
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
其他虚拟机管理程序
 a| 
支持在 KVM、Xen、Hyper-V 和超大规模虚拟机监控程序下运行的 Linux，其中来宾操作系统可以使用以下方法直接通过 TCP/IP 访问所需的 ONTAP 存储资源：
...
NOTE: VMware 之外不支持数据存储区和原始设备演示文稿。
