...
---
= SnapCenter 如何使用 Oracle RMAN 编录备份
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
可以通过运行 Get-Help command_name 获取有关可与命令一起使用的参数及其描述的信息。或者，您可以参考 https://library.netapp.com/ecm/ecm_download_file/ECMLP3359469["《 SnapCenter 软件命令参考指南》"^]。
