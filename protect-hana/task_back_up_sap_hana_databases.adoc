...
+
有关可与 cmdlet 结合使用的参数及其说明的信息，可通过运行 get-help _command_name_ 来获取。或者，您也可以参考 https://["《 SnapCenter 软件 cmdlet 参考指南》"]
...
+
有关信息，请参见 https://["MetroCluster 故障转移后无法检测 SnapMirror 或 SnapVault 关系"^]
