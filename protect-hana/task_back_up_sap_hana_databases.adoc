...
[role="lead"]
如果某个资源尚未加入任何资源组，您可以从 * 资源 * 页面备份该资源。
...
+
link:protect-hana/task_create_resource_groups_and_attach_policies.html["创建资源组并附加策略"]。

+
link:protect-hana/task_back_up_resource_groups_sap_hana.html["备份资源组"]
...
+
有关可与 cmdlet 结合使用的参数及其说明的信息，可通过运行 get-help _command_name_ 来获取。或者，您也可以参考 https://library.netapp.com/ecm/ecm_download_file/ECMLP2880726["《 SnapCenter 软件 cmdlet 参考指南》"]
