...
* 您必须在主机上安装 Java 17（用于 SnapCenter 6.2.1 及更高版本）或 Java 11（用于 SnapCenter 6.2 及更早版本）。
+
...
* 您必须在 Windows 主机上安装 Java 17（用于 SnapCenter 6.2.1 及更高版本）或 Java 11（用于 SnapCenter 6.2 及更早版本）。
+
...
* 您必须已为 root 用户或非 root 用户启用基于密码的 SSH 连接。
* 您必须在 Linux 主机上安装 Java 17（用于 SnapCenter 6.2.1 及更高版本）或 Java 11（用于 SnapCenter 6.2 及更早版本）。
+
link:https://www.oracle.com/java/technologies/downloads/#java17["下载适用于所有操作系统的 Java"]
