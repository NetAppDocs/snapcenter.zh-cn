...
---
= 为 SnapCenter PostgreSQL 创建资源组并附加策略
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
例如，如果归档日志文件为 log_backup_0_1.log，则指定 .log 作为文件扩展名。
...
NOTE: PostgreSQL Linux插件系统支持自定义键值对、而注册为集中式Windows插件的PostgreSQL集群则不支持此键值对。
