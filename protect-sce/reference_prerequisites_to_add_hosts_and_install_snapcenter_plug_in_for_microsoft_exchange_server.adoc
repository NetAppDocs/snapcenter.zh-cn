...
---
= 安装 SnapCenter Plug-in for Microsoft Exchange Server 的前提条件
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* 您必须将 Microsoft Exchange Server 用于独立和数据库可用性组配置。有关受支持的 Microsoft Exchange Server 版本，请参阅link:https://imt.netapp.com/imt/#search["互操作性表工具 (IMT)"^]。
...
* 确保以下端口在防火墙中未被阻塞，否则 add host 操作失败。要解决此问题，必须配置动态端口范围。有关详细信息，请参见 https://docs.microsoft.com/en-us/troubleshoot/windows-server/networking/configure-rpc-dynamic-port-allocation-with-firewalls["Microsoft 文档"^]。有关受支持的 Microsoft Exchange Server 版本，请参见link:https://imt.netapp.com/imt/#search["互操作性表工具 (IMT)"^]。
+
** 对于 Windows 2019 ，端口范围为 49152 - 65536
** 对于 Windows 2016 和 Exchange 2016 ，端口范围为 50000 - 51000
** 适用于 Windows 2012 R2 和 Exchange 2013 的端口范围 6000 - 6500
...
* Java 17（Oracle Java、OpenJDK 或 SAP JDK）或 Java 11（适用于 SnapCenter 6.2 或更早版本）
