...
Windows Server 上提供SnapCenter配置和数据保护支持。有关受支持版本的最新信息，请参阅 https://imt.netapp.com/imt/imt.jsp?components=180321;180339;&solution=1257&isHWU&src=IMT["NetApp 互操作性表工具"^]。
