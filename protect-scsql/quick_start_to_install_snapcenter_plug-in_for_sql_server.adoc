...
有关 ONTAP 和应用程序插件的最低要求，请参见 https://imt.netapp.com/matrix/imt.jsp?components=108408;&solution=1259&isHWU&src=IMT["互操作性表工具"^]
...
操作系统（ 64 位）
 a| 
请参见 https://imt.netapp.com/matrix/imt.jsp?components=108408;&solution=1259&isHWU&src=IMT["互操作性表工具"^]
...
=== 设置运行身份凭据以安装适用于Microsoft SQL Server的插件
...
=== 添加主机并安装适用于Microsoft SQL Server的插件
