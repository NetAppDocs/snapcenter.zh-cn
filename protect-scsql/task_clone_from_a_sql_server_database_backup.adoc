...
---
= 使用 SnapCenter 从 SQL Server 数据库备份克隆
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
对于 EMS，您可以参考 https://docs.netapp.com/us-en/snapcenter/admin/concept_manage_ems_data_collection.html["在 SnapCenter 中管理 EMS 数据收集"]
