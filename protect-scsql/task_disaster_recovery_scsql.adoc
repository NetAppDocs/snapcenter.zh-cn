...
---
= 灾难后恢复 SnapCenter Plug-in for SQL Server
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* 使用 *添加主机* 或 *修改主机* 页面将 SnapCenter Plug-in for SQL Server 推送到备用主机。有关详细信息，请参见 link:https://docs.netapp.com/us-en/snapcenter/admin/concept_manage_hosts.html["在 SnapCenter 中管理主机"]。
