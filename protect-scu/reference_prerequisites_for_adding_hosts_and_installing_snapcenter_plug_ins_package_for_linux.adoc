...
---
= 添加主机和安装适用于 Linux 的 SnapCenter 插件包的先决条件
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: RSA 密钥是 SnapCenter 唯一支持的 SSH 密钥格式。有关如何创建 SSH 密钥的详细信息，请参阅知识库文章 link:https://kb.netapp.com/data-mgmt/SnapCenter/SC_KBs/How_to_create_an_RSA_key_for_SnapCenter_SSH_Key_Based_credential["如何为基于 SnapCenter SSH 密钥的凭据创建 RSA 密钥"^]。
...
* 您必须在 Linux 主机上为 SnapCenter 6.2.1 及更高版本安装 Java 17，或为 SnapCenter 6.2 及更早版本安装 Java 11。
+

NOTE: 请确保仅在 Linux 主机上安装了 SnapCenter 6.2.1 及更高版本的 Java 17 认证版本或 SnapCenter 6.2 及更低版本的 Java 11 认证版本。

+
有关 Java 下载的信息，请参阅 link:https://www.oracle.com/java/technologies/downloads/#java17["下载适用于所有操作系统的 Java"^]。
...
|===
有关受支持版本的最新信息，请参见 https://imt.netapp.com/imt/imt.jsp?components=180320;180338;&solution=1257&isHWU&src=IMT["NetApp 互操作性表工具"^]。
