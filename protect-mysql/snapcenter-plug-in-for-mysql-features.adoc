...
summary: SnapCenter 可与插件应用程序以及存储系统上的 NetApp 技术集成。要使用适用于MySQL数据库的插件、请使用SnapCenter图形用户界面。 
---
...
[role="lead"]
SnapCenter 可与插件应用程序以及存储系统上的 NetApp 技术集成。要使用适用于MySQL数据库的插件、请使用SnapCenter图形用户界面。
...
+
SnapCenter将NetApp快照技术与适用于MySQL数据库的插件结合使用来备份资源。



使用适用于MySQL的插件还具有以下优势：
