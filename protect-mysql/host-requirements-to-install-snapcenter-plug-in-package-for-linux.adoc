...
---
= 安装适用于 Linux 的 SnapCenter 插件包之前的主机要求
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
有关受支持版本的最新信息，请参阅有关受支持版本的最新信息，请参阅 https://imt.netapp.com/imt/imt.jsp?components=180320;180338;&solution=1257&isHWU&src=IMT["NetApp 互操作性表工具"]。
