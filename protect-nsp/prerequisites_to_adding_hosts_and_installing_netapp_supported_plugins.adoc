...
* 您必须已为 SnapCenter 6.2.1 及更高版本安装 Java 17（Oracle Java 或 OpenJDK）或
* Linux、Windows 或 AIX 主机上用于 SnapCenter 6.2 及更早版本的 Java 11。
+
...
+
如果要使用 Windows Server 2019 或 Windows Server 2016 作为 SnapCenter Server 主机，则必须为 SnapCenter 6.2.1 及更高版本安装 Java 17（Oracle Java 或 OpenJDK），或为 SnapCenter 6.2 及更早版本安装 Java 11。
...
所需的软件包
 a| 
* 适用于 SnapCenter 6.2.1 及更高版本的 Java 17、IBM Java 或
* 适用于 SnapCenter 6.2 及更早版本的 Java 11，IBM Java
