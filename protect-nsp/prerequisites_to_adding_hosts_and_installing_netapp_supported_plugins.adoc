...
* 必须在 Linux、Windows 或 AIX 主机上安装 Java 17（Oracle Java、OpenJDK 或 SAP JDK）（适用于 SnapCenter 6.2.1 及更高版本）或 Java 11（适用于 SnapCenter 6.2 及更早版本）。
+
...
+
link:https://www.oracle.com/java/technologies/downloads/#java17["下载适用于 Windows 的 Java"]
...
* 必须在 Linux 主机上为 SnapCenter 6.2.1 及更高版本安装 Java 17（Oracle Java、OpenJDK 或 SAP JDK），或为 SnapCenter 6.2 及更早版本安装 Java 11。
+
如果要使用 Windows Server 2019 或 Windows Server 2016 作为 SnapCenter 服务器主机，则必须为 SnapCenter 6.2.1 及更高版本安装 Java 17（Oracle Java、OpenJDK 或 SAP JDK），或为 SnapCenter 6.2 及更早版本安装 Java 11。

+
link:https://www.oracle.com/java/technologies/downloads/#java17["下载适用于 Linux 的 Java"]
...
所需的软件包
 a| 
* Java 17 for SnapCenter 6.2.1 及更高版本，IBM Java 或 Java 11 for SnapCenter 6.2 及更早版本，IBM Java
