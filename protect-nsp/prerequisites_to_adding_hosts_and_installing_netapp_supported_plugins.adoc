...
* 您必须在 Linux、Windows 或 AIX 主机上安装 Java 17、Java 11（仅适用于 SnapCenter 6.2）。
+
...
+
如果要使用 Windows Server 2019 或 Windows Server 2016 作为 SnapCenter Server 主机，则必须安装 Java 17、Java 11（仅适用于 SnapCenter 6.2）。
...
所需的软件包
 a| 
Java 17、Java 11（仅适用于 SnapCenter 6.2）、IBM Java
