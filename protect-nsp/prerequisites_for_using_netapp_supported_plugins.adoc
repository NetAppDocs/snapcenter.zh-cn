...
---
= 将 NetApp 支持的插件与 SnapCenter 结合使用的前提条件
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* 添加主机，然后安装和上传插件。
* 如果适用，请在插件主机上安装适用于 SnapCenter 6.2.1 及更高版本的 Java 17（Oracle Java、OpenJDK 或 SAP JDK）或适用于 SnapCenter 6.2 及更早版本的 Java 11。
